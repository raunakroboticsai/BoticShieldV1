...
void BoticShieldV1::begin(uint8_t speed) {
  ...
  // Safety: stop motors before enabling
...
void BoticShieldV1::sharpLeft() {
  _shiftSend(BOTIC_SHARP_LEFT);
}

// Left motors forward, Right motors backward
void BoticShieldV1::sharpRight() {
  _shiftSend(BOTIC_SHARP_RIGHT);
}
...
void BoticShieldV1::moveFor(char direction, unsigned long ms) {
  ...
  switch (direction) {
    ...
    case 'S': case 's': sharpLeft();   break;
    case 'T': case 't': sharpRight();  break;
    default:             stop();       break;
  }
